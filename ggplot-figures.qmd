...
-   Communication = research success
...
```{=html}
<iframe width="1000" height="500" src="https://www.data.qld.gov.au/dataset/seq-koala-survey-data-2010-2015" title="Quarto Documentation"\>\</iframe>
```
```{r echo=FALSE}
library(tidyverse)
library(ggplot2)
...
Affects: - 1 in 12 men - 1 in 200 women
...
```{=html}
<iframe width="1000" height="500" src="https://siegal.bio.nyu.edu/color-palette/" title="Color blindness"\>\</iframe>
```
...
```{=html}
<iframe width="1000" height="500" src="https://patchwork.data-imaginist.com/" title="Color blindness"\>\</iframe>
```
